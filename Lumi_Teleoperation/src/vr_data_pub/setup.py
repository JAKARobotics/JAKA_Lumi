...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'teleoperation_control_lumi = vr_data_pub.teleoperation_control_lumi:main',
            'vr_robot_pose_converter = vr_data_pub.vr_robot_pose_converter:main',
            #'collect_data_xy = vr_data_pub.aloha_data_prepare_xy:main',
            'collect_data_lumi = vr_data_pub.aloha_data_prepare_lumi:main',
            'vr_robot_pose_converter_30degree = vr_data_pub.vr_robot_pose_converter_30degree:main',
            'vr_robot_pose_converter_lumi_servo_p = vr_data_pub.vr_robot_pose_converter_lumi_servo_p:main',
            'griptest = vr_data_pub.griptest:main',
        ],
    },
)
