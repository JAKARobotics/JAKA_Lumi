...
def main():
    ...
    parser.add_argument('--start-on-play', action='store_true', help='If present, to true.')
    ...
    simulation_app = SimulationApp({"headless": False})  # Change to True for headless mode
